...
export const metadata = {
  ...
  openGraph: {
    ...
    title:
      "Срочный выкуп авто в Минске и области — купим ваш автомобиль за 1 визит | AvtoCar",
    description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Срочный выкуп авто в Минске — автосалон AvtoCar, крытая парковка с автомобилями",
      },
    ],
  },
  twitter: {
    ...
    title:
      "Срочный выкуп авто в Минске — купим авто быстро и по рыночной цене | AvtoCar",
    description:
      "Хотите срочно продать автомобиль? Автовыкуп в Минске от AvtoCar: выезд оценщика, честная цена, оформление договора и оплата на месте.",
...
const jsonLd = {
  ...
  "@type": "AutoDealer",
  name: "Автосалон AvtoCar — выкуп авто в Минске",
  url: `${SITE_URL}/vykup-avto/`,
