...
export const metadata = {
	title:
		"Комиссионная продажа авто в Минске — авто на комиссию в автосалоне AvtoCar",
	description:
		"Комиссионная продажа авто в Минске в автосалоне AvtoCar. Поможем сдать авто на комиссию и выгодно продать машину: оценка, подготовка, реклама и прием авто на комиссию под ключ. Комиссионный автосалон с крытой площадкой и быстрой выплатой денег.",
	keywords,
	alternates: {
		canonical,
	},
	...
	ogTitle:
		"Комиссионная продажа авто в Минске — авто на комиссию в автосалоне AvtoCar",
	ogDescription:
		"Комиссионная продажа автомобиля в Минске. Поставить авто на комиссию, подготовка и продажа комиссионных автомобилей под ключ в автосалоне AvtoCar.",
	twitterTitle:
		"Комиссионная продажа авто в Минске — авто на комиссию | AvtoCar",
	twitterDescription:
		"Сдать авто на комиссию в Минске: оценка, подготовка, реклама и продажа авто по комиссии в автосалоне AvtoCar.",
	...
	openGraph: {
		...
		title:
			"Комиссионная продажа авто в Минске — авто на комиссию в автосалоне AvtoCar",
		description:
			"Авто на комиссию в Минске: оценка, подготовка, реклама и продажа комиссионных автомобилей на крытой площадке AvtoCar.",
		images: [
			{
				url: `${process.env.NEXT_PUBLIC_BASE_URL}/komissiya/komissionnaya-prodazha-hero-desktop.webp`,
				width: 1200,
				height: 630,
				alt: "Комиссионная продажа авто в Минске — авто на комиссию в автосалоне AvtoCar",
			},
		],
	},
	twitter: {
		...
		title:
			"Комиссионная продажа авто в Минске — авто на комиссию | Автосалон AvtoCar",
		description:
			"Поставить авто на комиссию и выгодно продать машину в Минске. Комиссионный автосалон AvtoCar: прием авто на комиссию и продажа под ключ.",
		images: [
...
const Page = () => {
	...
	const jsonLd = {
		...
		makesOffer: {
			...
			description:
				"Прием авто на комиссию, подготовка, реклама и продажа комиссионных автомобилей в автосалоне AvtoCar.",
			areaServed: {
				"@type": "City",
				name: "Минск",
			},
							...
							<div>
								...
								<h1 className="mt-6 font-semibold uppercase sd:text-[46px] sd:leading-[1.05] xz:text-[30px] xz:leading-[1.2] drop-shadow-[0_12px_40px_rgba(0,0,0,0.75)]">
									...
									<span className="block text-[#9af79e] text-[22px] sd:text-[26px] normal-case mt-3 font-semibold">
										авто на комиссию в Минске в автосалоне AvtoCar
									</span>
								</h1>
									...
									<div className="dropdown w-full dropdown-top sd:dropdown-end text-white">
										...
										>
											<p className="text-xs uppercase tracking-[0.18em] text-gray-400 mb-3">
												комиссионный автосалон avtocar
											</p>
				...
				<div className="relative rounded-3xl bg-gradient-to-br from-[#0c1013] via-[#121820] to-[#050608] border border-white/10 px-4 sd:px-8 py-12 shadow-[0_30px_90px_rgba(0,0,0,0.65)] overflow-hidden">
					...
					<div className="relative">
						...
						<p className="text-sm sd:text-base text-gray-300 max-w-2xl mb-8">
							Комиссионная продажа авто в Автосалоне AvtoCar — понятный и
						...
						<div className="grid sd:grid-cols-3 xz:grid-cols-1 gap-0 sd:gap-4">
							...
							<div className="border border-[#2c323c] border-dashed rounded-2xl p-4 bg-white/5">
								...
								<p className="text-gray-300 mt-2 text-sm">
									...
									<strong>комиссионную площадку авто</strong> AvtoCar в Минске,
					...
					<div className="relative">
						...
						<div className="grid sd:grid-cols-2 xz:grid-cols-1 gap-4">
							{[
								...
								{
									q: "Сколько стоит поставить авто на комиссию в AvtoCar?",
								...
								},
								{
									...
									a: "Наш комиссионный автосалон AvtoCar расположен по адресу: Минск, ул. Куйбышева 40, паркинг 4 этаж.",
								},
								{
