...
export const metadata = {
  title: "Трейд-ин авто в Минске — обмен авто на авто за 1 час | Автосалон на ул.Куйбышева 40",
  description:
    "Трейд-ин авто в Минске - автосалон на ул.Куйбышева 40. Обмен авто на авто с пробегом за ~1 час: честная оценка, возможность доплаты или кредита, большой выбор машин в трейд-ин. Приезжайте в Минск, ул. Куйбышева 40, паркинг 4 этаж.",
  keywords,
  alternates: {
    canonical,
  },
  openGraph: {
    ...
    title: "Трейд-ин авто в Минске — обмен авто на авто за 1 час | Автосалон на ул.Куйбышева 40",
    description:
      "Обмен авто в Минске по системе trade-in в автосалоне на ул.Куйбышева 40. Оценим машину по рыночной стоимости и подберём авто на обмен из большого ассортимента.",
    images: [
      {
        url: `${process.env.NEXT_PUBLIC_BASE_URL}/trade-in/tradein-hero-desktop.webp`,
        width: 1200,
        height: 630,
        alt: "Трейд-ин авто в Минске — обмен авто на авто в автосалоне на ул.Куйбышева 40",
      },
    ],
  },
  twitter: {
...
const Page = () => {
  ...
  const jsonLd = {
    ...
    makesOffer: {
      ...
      description:
        "Обмен авто на авто (trade-in) в автосалоне на ул.Куйбышева 40: оценка автомобиля, подбор машины на обмен, оформление сделки и кредита в один визит.",
      areaServed: {
        "@type": "City",
        name: "Минск",
      },
