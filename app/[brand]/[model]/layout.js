...
export async function generateMetadata({ params: { brand, model } }) {
	...
	const metaDescription = `⭐ ${formattedBrand} ${formattedModel} купить в Минске в кредит и лизинг ✫ Автосалон: Кредит и лизинг на б/у авто ➤➤➤ До 10 лет. ☎️ ${phoneNumbers.mainPhone} ⚡ Большой выбор автомобилей ⚡ Помощь в выборе авто ⭐ Офомление в день подачи ⭐ Без взоса ✓ Без справок и поручителей.`;
