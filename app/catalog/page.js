...
export const metadata = {
  title: "Авто c пробегом в Минске | Лизинг и Кредит | Каталог автосалона на ул.Куйбышева 40",
  description:
    `⭐ Автомобили б/у в самом крупном автосалоне Минска ⚡ Кредит и лизинг на авто с пробегом ➤➤➤ До 10 лет. ☎️ ${phoneNumbers.mainPhone} Автосалон в Минске ⚡ Большой выбор автомобилей ⚡ Помощь в выборе авто ⭐ Только проверенные авто ⭐ Без взоса ✓ Без справок и поручителей ✓ Звоните прямо сейчас!`,
  alternates: { canonical: "/catalog/" },
  openGraph: {
    title: "Купить авто c пробегом в Минске | Лизинг и Кредит | Каталог автосалона на ул.Куйбышева 40",
