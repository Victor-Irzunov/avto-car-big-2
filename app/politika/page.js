        ...
        <div className="container mx-auto text-white">
          ...
          <div className="mt-10 space-y-6">
            ...
            <p className="text-sm sm:text-base leading-7 text-gray-300">
              ...
              персональных данных, предпринимаемые ИП Матвеева И.М. (далее — Оператор).
            </p>
            <p className="text-sm sm:text-base leading-7 text-gray-300">
            ...
            <p className="text-sm sm:text-base leading-7 text-gray-300">
              ...
              <a href="mailto:Bletkoaleksandr364@gmail.com" className="underline text-primary"> Bletkoaleksandr364@gmail.com</a>
