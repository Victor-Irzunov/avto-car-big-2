				...
				<div className='bg-white/80 rounded-3xl sd:py-16 xz:py-5 sd:px-10 xz:px-2'>
					...
					<div className='grid sd:grid-cols-2 xz:grid-cols-1 gap-4 sd:mt-8 xz:mt-0'>
						<div className='bg-[#1B1464] rounded-3xl sd:px-7 xz:px-4 py-9'>
							<h3 className='sd:block xz:hidden sd:text-5xl xz:text-3xl font-semibold text-white'>Быстрый подбор авто</h3>
							<h3 className='sd:hidden xz:block sd:text-5xl xz:text-3xl font-semibold text-white'>Подбор авто</h3>
							<div className='mt-6'><FormPodborAvto /></div>
						</div>

						<div className='sd:grid xz:hidden sd:grid-cols-3 xz:grid-cols-1 gap-4'>
							<Link href={`/credit/`} prefetch className="cursor-pointer">
								<div className='bg-white rounded-3xl p-3'>
									<h3 className='text-3xl font-semibold text-neutral'>Кредит</h3>
							...
							<Link href={`/lizing/`} prefetch className="cursor-pointer">
								<div className='bg-[#2D3192] rounded-3xl p-3'>
									<h3 className='text-3xl font-semibold text-white'>Лизинг</h3>
									<div className='flex justify-end mt-3'>
							...
							<Link href={`/obmen/`} prefetch className="cursor-pointer">
								<div className='bg-white rounded-3xl p-3'>
									<h3 className='text-3xl font-semibold text-neutral'>Traid-in</h3>
									<div className='flex justify-end mt-3'>
							...
							<Link href={`/vykup-avto/`} prefetch className="cursor-pointer">
								<div className='bg-[#2D3192] rounded-3xl p-3'>
									<h3 className='text-3xl font-semibold text-white'>Выкуп авто</h3>
									<div className='flex justify-end mt-3'>
							...
							<Link href={`/komissionnaya-prodazha/`} prefetch className="cursor-pointer col-span-2">
								<div className='bg-[#1B1464] rounded-3xl p-3'>
									<h3 className='text-3xl font-semibold text-white'>Комиссионная продажа</h3>
									<div className='flex justify-end mt-3'>
							...
							<Link href={`/prigon-iz-es/`} prefetch className="cursor-pointer col-span-2">
								<div className='bg-white rounded-3xl p-3'>
									<h3 className='text-3xl font-semibold text-neutral'>Пригон авто из Европы</h3>
							...
							<Link href={`/obmen/`} prefetch className="cursor-pointer">
								<div className='bg-[#2D3192] rounded-3xl p-3'>
									<h3 className='text-3xl font-semibold text-white'>Обмен</h3>
