  ...
  return (
    <section className="my-10">
      <div className="container mx-auto">
        <div className='bg-white py-16 sd:py-24 sd:px-6 xz:px-3 rounded-2xl'>
        <div className="grid gap-10 sd:gap-16 sd:grid-cols-[minmax(0,1.1fr)_minmax(0,1.4fr)] items-start">
          {/* ЛЕВАЯ ЧАСТЬ — H2 */}
          <div>
            <h2 className="text-[#145227] font-semibold leading-tight xz:text-[28px] sd:text-[48px] sd:leading-[1.05]">
              Сотрудничаем
              <br />
              с проверенными
              <br />
