...
import phoneNumbers, { companyInfo } from "@/config/config";
      ...
      <div className="container mx-auto xz:block sd:hidden">
        ...
        <div className="text-sm space-y-6 mb-8">
          <div>
            ...
            <p className="leading-snug">{companyInfo.visitAddress}</p>
          </div>
        ...
        <div className="border-t border-[#3D3D3D] pt-4 mt-2 text-[11px] text-gray-300 space-y-1">
          <p>
            {companyInfo.companyName} УНП {companyInfo.unp},{" "}
            {companyInfo.legalAddress}
          </p>
          <p>
            Банк: {companyInfo.bankName}, {companyInfo.bankAddress}, БИК банка:{" "}
            {companyInfo.bik}, р/с: {companyInfo.account}
          </p>
        </div>
        ...
        <div className="mt-4 text-[11px] text-gray-400 space-y-1">
          ...
          <p>
            <Link href="/cookie-policy">Обработка персональных данных</Link>
          </p>
      ...
      <div className="container mx-auto hidden sd:block">
        ...
        <div className="flex items-start justify-between gap-12">
          ...
          <div className="text-sm max-w-xs">
            ...
            <p className="mb-4 leading-snug">{companyInfo.visitAddress}</p>
        ...
        <div className="mt-10 border-t border-[#3D3D3D] pt-8 relative mb-10">
          ...
          <div className="flex items-center justify-between mt-20">
            ...
            <div className="text-[11px] text-gray-400 max-w-sm text-right space-y-1">
              ...
              <p>
                Банк: {companyInfo.bankName}, {companyInfo.bankAddress}, БИК
                банка: {companyInfo.bik}, р/с: {companyInfo.account}
              </p>
            </div>
          </div>
        </div>
