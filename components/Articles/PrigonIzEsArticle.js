				...
				<div className="mt-12">
					...
					<div className=''>
						<h3 className="mt-6 sd:text-4xl xz:text-2xl font-semibold">
							Доставка автомобилей из Европы: Автосалон на ул.Куйбышева 40
						</h3>
